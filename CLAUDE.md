...
- If a working-copy xlsx ever parses to garbage (misaligned sheets, stripped
  values), re-extract the pristine original from the yearly zips on
  /Volumes/Main — that's how the once-corrupt 201002.xlsx was recovered.
